...
def cvo_o3_NC_Global_Attributes_v1(nc, meta, ET):
   ...
   nc.processing_level = meta[21]
   nc.last_revised_date = datetime.now(pytz.UTC).isoformat()
   nc.project = meta[23]
   nc.project_principle_investigator = meta[24]
   nc.project_principle_investigator_email = meta[25]
   nc.project_principle_investigator_url = meta[26]
   nc.licence = meta[27]
   ...
   nc.amf_vocabularies_release[40]
   nc.history = meta[41]
   nc.comment = meta[42]
   #flags
   nc.qc_flag_comment = meta[44]
   nc.qc_flag_value_0_description = meta[45]
   nc.qc_flag_value_1_description = meta[46]
   nc.qc_flag_value_1_assessment = meta[47]
   nc.qc_flag_value_2_description = meta[48]
   nc.qc_flag_value_2_assessment = meta[49]
   nc.qc_flag_value_3_description = meta[50]
   nc.qc_flag_value_3_assessment = meta[51]
